...
This updates `local.json` and the AppHost launch profile: application, private D1/
...
configuration command refuses to change a running AppHost.
...
This remains a local preview (`0.1.0-local.1`), with pinned dependencies. Framework
