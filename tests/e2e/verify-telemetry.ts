...
const required = ["flarestack.alchemy", "flarestack.worker", "flarestack.auth", "flarestack.email", ...(fast ? ["flarestack.watch"] : ["flarestack.dotnet", "flarestack.container-proxy"])];
