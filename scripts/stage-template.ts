...
for (const file of ["aspire.ts", "sign-in.ts", "todo.spec.ts", "accounts.ts", "local.ts", "accounts.spec.ts", "admin.spec.ts", "hot-reload.spec.ts", "verify-telemetry.ts"]) {
